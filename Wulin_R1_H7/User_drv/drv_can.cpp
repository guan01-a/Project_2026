...
void FDCAN_Init(FDCAN_HandleTypeDef *hfdcan, FDCAN_Call_Back Callback_Function)
{
    ...
    else if (hfdcan->Instance == FDCAN2)
    {
        ...
        FDCAN_Filter_Mask_Config(hfdcan, FDCAN_FILTER(4) | FDCAN_FIFO_0 | FDCAN_STDID | FDCAN_DATA_TYPE, 0, 0);
        FDCAN_Filter_Mask_Config(hfdcan, FDCAN_FILTER(5) | FDCAN_FIFO_1 | FDCAN_EXTID | FDCAN_DATA_TYPE, 0, 0);
