 ...
 */
void Class_Motor_DJI_GM6020::Init(FDCAN_HandleTypeDef *hfdcan, 
    Enum_Motor_DJI_ID __FDCAN_Rx_ID, Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method, int32_t __Encoder_Offset, Enum_Motor_DJI_GM6020_Driver_Version __Driver_Version, Enum_Motor_DJI_Power_Limit_Status __Power_Limit_Status, float __Voltage_Max, float __Current_Max)
{
    //绑定对应结构体至电机CAN结构体
