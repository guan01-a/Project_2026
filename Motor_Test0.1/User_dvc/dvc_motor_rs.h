...
class Class_Motor_RS_MIT
{
    ...
    void Init(FDCAN_HandleTypeDef *hfdcan, uint8_t __CAN_Tx_ID, uint8_t __CAN_Rx_ID, 
        Enum_Motor_RS_Control_Method __Motor_RS_Control_Method = Motor_RS_Control_Method_NORMAL, 
        float __Angle_Max = 12.57f, float __Omega_Max = 33.0f, float __Torque_Max = 14.0f, float __Current_Max = 10.261194f);
